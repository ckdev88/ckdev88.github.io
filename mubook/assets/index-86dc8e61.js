...
function Hu(t, e) {
	...
	for (const c of t) {
		...
		for (let h = 0; h < c.length; h++) {
			...
			if (f.type === 0) h || (r += '/'), (r += f.value.replace(Bu, '\\$&')), (g += 40);
			else if (f.type === 1) {
...
function Yu(t, e) {
	...
	function l(u) {
		...
		for (
			;
			h < n.length && Ku(u, n[h]) >= 0 && (u.record.path !== n[h].record.path || !wa(u, n[h]));
	...
	function c(u, h) {
		...
		return { name: b, path: y, params: g, matched: S, meta: Zu(S) };
	}
	return (
		t.forEach((u) => i(u)),
...
function uh(t) {
	return ar(t).replace(nh, '%3D');
}
function hh(t) {
	return Fr(t).replace(ka, '%23').replace(sh, '%3F');
}
function fh(t) {
	return t == null ? '' : hh(t).replace(th, '%2F');
}
function ls(t) {
	try {
...
function Vi(t) {
	const e = Ve(Ss),
		...
		i = Ne(() => r.value > -1 && bh(n.params, s.value.params)),
		o = Ne(() => r.value > -1 && r.value === n.matched.length - 1 && _a(n.params, s.value.params));
	function a(l = {}) {
		return vh(l) ? e[Re(t.replace) ? 'replace' : 'push'](Re(t.to)).catch(kn) : Promise.resolve();
	}
...
function Eh(t) {
	...
	function A(v, I) {
		...
		const d = Tu(s, re({}, v, { hash: ch(ee), path: q.path })),
			p = r.createHref(d);
		return re({ fullPath: d, hash: ee, query: s === Bi ? ph(v.query) : v.query || {} }, q, {
			redirectedFrom: void 0,
			href: p,
		});
	}
	...
	const Mt = new Set(),
		Un = {
			...
			install(v) {
				const I = this;
				v.component('RouterLink', yh),
					v.component('RouterView', kh),
...
function Ah() {
	...
	const r = gs({
		...
		use(i) {
			return !this._a && !Rh ? s.push(i) : n.push(i), this;
		},
		_p: n,
		_a: null,
		_e: t,
...
const Ph = Symbol();
function xh(t) {
	return !cr(t) || !t.hasOwnProperty(Ph);
}
...
function Ca(t, e, n = {}, s, r, i) {
	...
	const R = {
		...
		j = qn(R);
	s._s.set(t, j);
	const Q = ((s._a && s._a.runWithContext) || Oh)(() => s._e.run(() => (o = vo()).run(e)));
	for (const U in Q) {
		const B = Q[U];
		if ((de(B) && !Ch(B)) || gt(B))
			i || (y && xh(B) && (de(B) ? (B.value = y[U]) : ur(B, y[U])), (s.state.value[t][U] = B));
...
function $h(t, e, n) {
	...
	function o(a, l) {
		...
		return (
			...
			a && Ts(a),
			(a = Oa),
			a._s.has(s) || (i ? Ca(s, e, r, a) : Ih(s, r, a)),
			a._s.get(s)
		);
	}
	return (o.$id = s), o;
...
const Ia = (t, e) => {
	...
	qh = (t) => (Vo('data-v-c53bb126'), (t = t()), Ko(), t),
	Nh = { class: 'quote' },
	Dh = qh(() => te('br', null, null, -1)),
	Uh = {
		__name: 'QuoteCard',
		setup(t) {
			const e = [
	...
	Mh = Ia(Uh, [['__scopeId', 'data-v-c53bb126']]),
	hr = $h('AuthStore', {
...
const Fh = (t) => (Vo('data-v-d0619b34'), (t = t()), Ko(), t),
	Bh = { class: 'name' },
	Hh = Fh(() => te('br', null, null, -1)),
	Vh = {
		__name: 'HomePage',
		...
		setup(t) {
			...
			return (n, s) => {
				...
				return (
					qe(),
					ht('div', null, [
						te('h1', null, [jt(' Ola '), te('span', Bh, Ct(Re(e).screenname), 1), jt('! ')]),
						Re(e).username
							? jc('', !0)
							: (qe(),
								Nr(
	...
	Kh = Ia(Vh, [['__scopeId', 'data-v-d0619b34']]),
	Wh = [
		{
			path: '/',
			children: [
				{ path: '/', name: 'home', component: Kh, meta: { includeNav: !0 } },
				{
					path: '/routeinfo',
					name: 'routeinfo',
					component: () => se(() => import('./RouteinfoPage-e587cf32.js'), []),
				...
				},
				{
					path: '/quotes',
					name: 'quotes',
					component: () => se(() => import('./QuotesPage-e388faf2.js'), []),
					meta: { includeNav: !0 },
				},
				{
					path: '/states',
					...
					component: () =>
						se(
							() => import('./GlobalStates-7190a6b7.js'),
							['assets/GlobalStates-7190a6b7.js', 'assets/CountStore-19cb4d30.js']
						),
					meta: { includeNav: !1 },
				},
				{
					...
					component: () =>
						se(
							() => import('./BoekzoekPage-02c3fd5b.js'),
							['assets/BoekzoekPage-02c3fd5b.js', 'assets/BoekzoekPage-1b89aba5.css']
						),
					meta: { includeNav: !0 },
				},
				{
					path: '/books',
					name: 'books',
					component: () => se(() => import('./BooksPage-30c1c84f.js'), []),
					meta: { includeNav: !0 },
				},
				{
					path: '/mubooks',
					name: 'mubooks',
					component: () => se(() => import('./MuPage-ffa5caed.js'), []),
					meta: { includeNav: !0 },
				},
				{
					path: '/bookstore',
					...
					component: () =>
						se(
							() => import('./BookstorePage-f3eb2e9c.js'),
							['assets/BookstorePage-f3eb2e9c.js', 'assets/BookstorePage-ecbbb25a.css']
						),
					meta: { includeNav: !0 },
				},
				{
					path: '/series',
					name: 'series',
					component: () => se(() => import('./SeriesPage-66e7b99a.js'), []),
					meta: { includeNav: !0 },
				},
			],
		},
			...
			children: [
				{
					...
					component: () =>
						se(
							() => import('./CreatePage-0ae09f9d.js'),
							['assets/CreatePage-0ae09f9d.js', 'assets/CreatePage-58996adf.css']
						),
				...
				},
				{
					path: '/checkmail',
					name: 'checkmail',
					component: () => se(() => import('./CheckMailPage-75b1e85c.js'), []),
				...
				},
				{
					path: '/welcome',
					name: 'welcome',
					component: () => se(() => import('./WelcomePage-3dbe479a.js'), []),
					meta: { requiresAuth: !1, requiresNoAuth: !1, includeNav: !1 },
				},
				{
					path: '/login',
					...
					component: () =>
						se(
							() => import('./LoginPage-a136fbc7.js'),
							['assets/LoginPage-a136fbc7.js', './assets/LoginPage-dad777e6.css']
						),
					meta: { requiresAuth: !1, requiresNoAuth: !0, includeNav: !0 },
				},
				{
					...
					component: () => se(() => import('./PreferencesPage-698db670.js'), []),
				...
				},
				{
					...
					component: () =>
						se(
							() => import('./SecretPage-4d03b8db.js'),
							['assets/SecretPage-4d03b8db.js', 'assets/SecretPage-98d57437.css']
						),
				...
				},
				{
					path: '/logout',
					name: 'logout',
					component: () => se(() => import('./LogoutPage-9491ee3f.js'), []),
					meta: { requiresAuth: !0, requiresNoAuth: !1, includeNav: !0 },
				},
				{
					path: '/profile-unauthorized',
					name: 'profile-unauthorized',
					component: () => se(() => import('./UnauthorizedPage-00d316f4.js'), []),
		...
		},
		{
			...
			component: () =>
				se(
					() => import('./CompoPage-869f526a.js'),
					[
						'assets/CompoPage-869f526a.js',
						'assets/useCountStore-b7d1711e.js',
						'assets/CountStore-19cb4d30.js',
					]
				),
			children: [
				{
					path: 'comments',
					name: 'comments',
					component: () => se(() => import('./CommentsPage-fa071f30.js'), []),
				},
				{
					path: '/counter',
					name: 'counter',
					component: () =>
						se(
							() => import('./CounterPage-f5997425.js'),
							['assets/CounterPage-f5997425.js', 'assets/useCountStore-b7d1711e.js']
						),
				},
				{
					path: '/posts',
					name: 'posts',
					component: () => se(() => import('./PostsPage-0480d458.js'), []),
				},
				{
					path: '/supabase-test',
					name: 'supabase-test',
					component: () => se(() => import('./SupabaseTest-2bb4fca2.js'), []),
				},
				{
					path: '/compo',
					name: 'compo',
		...
		{},
		{
			path: '/:catchAll(.*)',
			name: '404',
			component: () => se(() => import('./404Page-5aced5bb.js'), []),
		},
	],
	Gh = (t) => {
		let e;
...
class Xh {
	constructor(e, { headers: n = {}, customFetch: s } = {}) {
		(this.url = e), (this.headers = n), (this.fetch = Gh(s));
	}
	setAuth(e) {
	...
	invoke(e, n = {}) {
		...
		return Qh(this, void 0, void 0, function* () {
			try {
				...
				if (u && u === 'true') throw new Jh(c);
				if (!c.ok) throw new Yh(c);
...
const ef = hn.fetch,
	...
	Dn = Object.freeze(
		Object.defineProperty(
			{ __proto__: null, Headers: $a, Request: tf, Response: nf, default: Hr, fetch: ef },
			Symbol.toStringTag,
			{ value: 'Module' }
		)
	);
...
const af = '1.9.1',
	lf = { 'X-Client-Info': `postgrest-js/${af}` };
class Vr {
	constructor(e, { headers: n = {}, schema: s, fetch: r } = {}) {
		(this.url = e),
			(this.headers = Object.assign(Object.assign({}, lf), n)),
			(this.schemaName = s),
			(this.fetch = r);
	}
	from(e) {
...
const cf = '2.9.1',
	uf = { 'X-Client-Info': `realtime-js/${cf}` },
	hf = '1.0.0',
	ja = 1e4,
	ff = 1e3;
var sn;
...
const Qi = (t, e, n = {}) => {
		...
		return Object.keys(e).reduce((i, o) => ((i[o] = pf(o, t, e, r)), i), {});
	},
	pf = (t, e, n, s) => {
	...
	vf = (t) => (typeof t == 'string' ? t.replace(' ', 'T') : t);
var Xi;
(function (t) {
...
class kf {
	...
	connect() {
		if (!this.conn) {
			...
			(this.conn = new Ef(this._endPointURL(), void 0, {
				close: () => {
					this.conn = null;
				},
			})),
	...
	_endPointURL() {
		return this._appendParams(this.endPoint, Object.assign({}, this.params, { vsn: hf }));
	}
	_onConnMessage(e) {
		...
		if (this.isConnected()) {
			if (this.pendingHeartbeatRef) {
				(this.pendingHeartbeatRef = null),
					...
					(e = this.conn) === null || e === void 0 || e.close(ff, 'hearbeat timeout');
				return;
			}
...
const xf = { limit: 100, offset: 0, sortBy: { column: 'name', order: 'asc' } },
...
class Cf {
	...
	list(e, n, s) {
		return Le(this, void 0, void 0, function* () {
			try {
				const r = Object.assign(Object.assign(Object.assign({}, xf), n), { prefix: e || '' });
				return {
					data: yield ut(
						this.fetch,
...
class jf {
	constructor(e, n = {}, s) {
		(this.url = e), (this.headers = Object.assign(Object.assign({}, $f), n)), (this.fetch = Na(s));
	}
	listBuckets() {
...
class Lf extends jf {
	...
	from(e) {
		return new Cf(this.url, this.headers, e, this.fetch);
	}
}
const qf = '2.39.2';
let yn = '';
typeof Deno < 'u'
	...
	: typeof document < 'u'
		...
		: typeof navigator < 'u' && navigator.product === 'ReactNative'
			? (yn = 'react-native')
			: (yn = 'node');
const Nf = { 'X-Client-Info': `supabase-js-${yn}/${qf}` };
var Df =
	(globalThis && globalThis.__awaiter) ||
	function (t, e, n, s) {
		function r(i) {
...
const Uf = (t) => {
	...
	Mf = () => (typeof Headers > 'u' ? $a : Headers),
	Ff = (t, e, n) => {
		const s = Uf(n),
			r = Mf();
		return (i, o) =>
			Df(void 0, void 0, void 0, function* () {
				var a;
...
function Vt() {
	...
	return crypto.getRandomValues(e), Array.from(e, Yf).join('');
}
async function Qf(t) {
...
const Yt = (t) => t.msg || t.message || t.error_description || t.error || JSON.stringify(t),
	sd = [502, 503, 504];
async function io(t) {
	if (!Wf(t)) throw new gr(Yt(t), 0);
	if (sd.includes(t.status)) throw new gr(Yt(t), t.status);
	let e;
	try {
		e = await t.json();
	} catch (n) {
	...
	throw typeof e == 'object' &&
		...
		? new td(Yt(e), t.status, e.weak_password.reasons)
		: new Zf(Yt(e), t.status || 500);
}
const rd = (t, e, n, s) => {
	const r = { method: t, headers: (e == null ? void 0 : e.headers) || {} };
	return t === 'GET'
...
function Tt(t) {
	var e;
	let n = null;
	cd(t) && ((n = Object.assign({}, t)), t.expires_at || (n.expires_at = Vf(t.expires_in)));
...
function ad(t) {
	const { action_link: e, email_otp: n, hashed_token: s, redirect_to: r, verification_type: i } = t,
		o = nd(t, ['action_link', 'email_otp', 'hashed_token', 'redirect_to', 'verification_type']),
...
const Fa = '2.62.0',
	fd = 'http://localhost:9999',
	dd = 'supabase.auth.token',
	pd = { 'X-Client-Info': `gotrue-js/${Fa}` },
	ao = 10,
	gd = {
				...
				if (r) {
					...
					if (e === 0)
						throw (
							...
							new _d(`Acquiring an exclusive Navigator LockManager lock "${t}" immediately failed`))
						);
					if (Gt.debug)
						try {
...
class jn {
	constructor(e) {
		...
		const r = Object.assign(Object.assign({}, vd), e);
		if (
			...
			(this.admin = new hd({ url: r.url, headers: r.headers, fetch: r.fetch })),
			(this.url = r.url),
	...
	async _signOut({ scope: e } = { scope: 'global' }) {
		return await this._useSession(async (n) => {
			...
			if (o) {
				...
				if (a && !(ed(a) && (a.status === 404 || a.status === 401))) return { error: a };
			}
			return (
				e !== 'others' &&
					(await this._removeSession(),
...
const kd = { headers: Nf },
	Ed = { schema: 'public' },
	Sd = { autoRefreshToken: !0, persistSession: !0, detectSessionInUrl: !0, flowType: 'implicit' },
	Td = {};
class Rd {
	constructor(e, n, s) {
		var r, i, o, a, l, c, u, h;
		...
		const g = `sb-${new URL(this.authUrl).hostname.split('.')[0]}-auth-token`,
			y = {
				db: Ed,
				realtime: Td,
				auth: Object.assign(Object.assign({}, Sd), { storageKey: g }),
				global: kd,
			},
			b = Hf(s ?? {}, y);
		(this.storageKey =
	...
	get functions() {
		return new Xh(this.functionsUrl, { headers: this.headers, customFetch: this.fetch });
	}
	get storage() {
		return new Lf(this.storageUrl, this.headers, this.fetch);
	}
	channel(e, n = { config: {} }) {
...
const Ad = (t, e, n) => new Rd(t, e, n),
	Od = 'https://ysuqkwlvbkjhfrqelfzb.supabase.co',
	Pd =
						...
						ht(
							...
							[
								te('nav', Cd, [
									...
									te('div', null, [
										te('button', { class: 'toggleZoekNav', onClick: n }, Ld),
										te(
											'button',
											{
												id: 'toggleNavProfile',
	...
	Bd = { id: 'header' },
	Hd = { id: 'main' },
	Vd = te('footer', { id: 'footer' }, null, -1),
	Kd = {
		__name: 'App',
		setup(t) {
			return (e, n) => {
				const s = $r('RouterView');
				return qe(), ht(Te, null, [te('header', Bd, [he(Fd)]), te('main', Hd, [he(s)]), Vd], 64);
			};
		},
	},
	zr = vu(Kd);
let Ha = Eh({ history: Uu(), routes: Wh }),
	Jn = on(!1);
Ha.beforeEach(async (t, e) => {
	if (
		...
		if (
			((await xd.auth.getSession()).data.session === null ? (Jn = !1) : (Jn = !0),
